...
def analysis_to_csv(analysis: RepoAnalysis, compact: bool = False) -> str:
    ...
    fieldnames = [
        "rank", "signal", "rule_id", "severity", "impact", 
        "score_contribution", "title", "file", "start_line", 
        "duplicate_count", "next_step"
    ]
    ...
    if compact_findings:
        writer.writerows(compact_findings)
